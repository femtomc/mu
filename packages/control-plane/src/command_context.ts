...
export type CommandContextResolutionSource = "explicit" | "conversation" | "none";

export type CommandContextResolutionFailureReason =
	| "context_missing"
	| "context_ambiguous"
	| "context_unauthorized"
	| "cli_validation_failed";

export type CommandContextResolutionDecision =
	| {
			kind: "resolved";
			repoRoot: string;
			commandKey: string;
			...
			targetId: string;
			source: CommandContextResolutionSource;
	  }
	| {
			kind: "reject";
			reason: CommandContextResolutionFailureReason;
			details?: string;
	  };

export type ResolveCommandContextInput = {
	repoRoot: string;
	commandKey: string;
...
export interface CommandContextResolverLike {
	resolve(opts: ResolveCommandContextInput): CommandContextResolutionDecision;
}

export type DefaultCommandContextResolverOpts = {
...
function reject(reason: CommandContextResolutionFailureReason, details?: string): CommandContextResolutionDecision {
	return {
		kind: "reject",
		reason,
		details,
...
function resolveFromCandidates(opts: {
	...
	| { kind: "resolved"; value: string; source: CommandContextResolutionSource }
	| { kind: "reject"; reason: CommandContextResolutionFailureReason; details?: string } {
...
export class DefaultCommandContextResolver implements CommandContextResolverLike {
	readonly #allowedRepoRoots: Set<string> | null;

	public constructor(opts: DefaultCommandContextResolverOpts = {}) {
	...
	public resolve(opts: ResolveCommandContextInput): CommandContextResolutionDecision {
