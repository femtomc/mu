export function guideText(): string {
	return [
		...
		"      viewer        Read-only",
		"",
		"  Serve (API + Web UI + terminal chat)",
		"    mu serve",
		"    mu serve --port 3000 --no-open",
		"    (mu serve immediately attaches terminal chat; type /exit to stop)",
		"",
		"  Login / Auth",
		"    mu login --list",
		...
		"    The same terminal also hosts the operator chat session.",
		"",
		"  Too much ANSI color:",
