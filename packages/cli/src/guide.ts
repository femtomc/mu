export function guideText(): string {
	return [
		...
		"",
		"Quickstart",
		"  1) Start a run (auto-initializes `.mu/`, starts serve lifecycle, queues run, attaches operator terminal):",
		...
		"    mu run <prompt...> --max-steps 20 --no-open",
		...
		"      mu resume <root-id> --max-steps 20",
		"",
		"  Operator session in scripts/CI:",
