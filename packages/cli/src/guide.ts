export function guideText(): string {
	return [
		...
		"      /mu plan ...      (phases, checklist editing, communication state, snapshot)",
		"      /mu subagents ... (scope filters, spawn profiles, pause policy, refresh/staleness controls, snapshot)",
		"",
		"  Replay",
