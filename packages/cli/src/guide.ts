export function guideText(): string {
	return [
		...
		"      1) mu control status",
		"      2) mu control link --channel telegram --actor-id <chat-id> --tenant-id bot",
		"      3) mu heartbeats create --title \"Telegram heartbeat\" --every-ms 300000 --reason telegram_heartbeat",
		"",
		"  Operator sessions",
